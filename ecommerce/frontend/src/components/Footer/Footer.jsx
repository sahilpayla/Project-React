      ...
      <div className="container">
         <footer className="py-5">
            <div className="row">
               <div className="col-6 col-md-2 mb-3">
                  ...
                  <ul className="nav flex-column">
                     ...
                     <li className="nav-item mb-2"><a to="#" className="nav-link p-0 text-muted">FAQs</a></li>
                     <li className="nav-item mb-2"><a to="#" className="nav-link p-0 text-muted">About</a></li>
                  </ul>
               </div>
            ...
            <div className="d-flex flex-column flex-sm-row justify-content-between py-4 my-4 border-top">
               <p>© 2023 Game Shopping Company, Inc. All rights reserved.</p>
            </div>
         </footer>
      </div>
